...
//  SDFoundation
//
//  Created by SoalHunag on 2020/7/24.
...
// MARK: 音频播放器
open class AudioPlayer: NSObject, AudioPlayerType, AVAudioPlayerDelegate {
    ...
    deinit {
        ...
        NotificationCenter.default.sd.removeObserver(interruptionToken)
        NotificationCenter.default.sd.removeObserver(routeChangeToken)
    }
